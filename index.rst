BIGIP Access Policy Manager(APM) Solution Guides 
==================================================
...
.. toctree::
   ...
   solution16/solution.rst

Nginx Access Solutions Guide
============================

The solutions documented on this site are designed to provide example configurations to address a given scenario.

Each solution has an accompanying guide that provides a detailed overview of the components used in the configuration and the workflow used for the authentication solution.

To deploy a solution you must be logged into UDF (https://udf.f5.com). From there you need to access the Access Labs and Solution Nginx Blueprint. F5ers can access the blueprint directly from UDF without launching a course.  If you are a partner or customer please reach out to your account team.  They will be able to create a course for you to access the environment.
